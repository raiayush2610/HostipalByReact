...
function Listdoc() {
          ...
          const getDoctor =async() =>{
                    try {
                         const res= await axios.get('http://localhost:4000/Doc/api/doctors')
          ...
          <div className='admin'>
                <div className="patlist">
                    <details>
                              ...
                              <table id="customers" >
                    <tr>
                              <th>Doctor Full name</th><th>Speclization</th><th>Year of Experience</th><th>Doctor Email</th><th>Doctor Number</th><th>Doctor Area </th>
                    </tr>
                                {
                                   Doctors.map((doc=>
                                       <tr>
